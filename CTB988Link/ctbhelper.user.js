...
ContentScript={
	...
	CreateHtmlElement:function(){
		var htmlList = '<div id="drag" style="width: 150px; height: 120px; cursor: move; position: absolute; border: solid 1px #ccc; float: right; z-index: 100;right: 0;top: 0;min-height: 250px;overflow-y: auto;max-height: 600px;">';
        ...
        htmlList += '<div style="font-size: 12px;"><a href="javascript:ContentScript.OpenConfigPage()">SET</a></div>';	
